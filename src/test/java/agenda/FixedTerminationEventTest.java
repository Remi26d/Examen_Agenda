...
public class FixedTerminationEventTest {
    ...
    @Test
    public void testRepetitionWithoutTermination() {
        Event eventWithoutTermination = new Event("No termination weekly", nov_1__2020_22_30, min_120);
        eventWithoutTermination.setRepetition(ChronoUnit.WEEKS);

        assertThrows(UnsupportedOperationException.class, eventWithoutTermination::getNumberOfOccurrences,
                "Une exception doit être levée si aucune terminaison n'est définie");
        assertThrows(UnsupportedOperationException.class, eventWithoutTermination::getTerminationDate,
                "Une exception doit être levée si aucune terminaison n'est définie");
    }
